...
if __name__ == '__main__':
    ...
    vel_conf = VelConf(max_y_velocity=0.4, normal_height=0.4, low_height=0.15, safe_angle=15, high_acceleration=11, max_priority=2)
    pos_conf = PosConf(max_x_distance=0.15, max_priority=1)
